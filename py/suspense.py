...
base_url = 'https://www.douban.com/doulist/16002/?start='  # 设定一个网址不变的部分，然后我们只要每次在这个后面加数字就可以了   16002另外一 57376
if os.path.exists('suspense'):
    os.chdir("suspense")
else:
    os.mkdir("suspense")
    os.chdir("suspense")
for num in range(0,12):
    ...
    for item in items:
        ...
        print(title)
        with open('悬疑电影.txt','a',encoding='utf-8') as f:
